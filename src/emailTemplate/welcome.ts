export const generateWelcomeEmail = (firstName) => {
  return {
      ...
      <td class="container">
        <div class="content">
          <div class="pre-white" style="margin: 30px 0">
            <img src="https://gstock.sg/media/queldorei/shopper/logo.png" width="40%">
            <h1>Welcome to Gstock Sg</h1>
          </div>
          ...
          <p>Have you checked out our collection of our fabulous items?</p>

          <p>It’s specially handpicked and uploaded by our esteemed merchant team, and we’re so pleased to tell you about that.</p>

          <p>Take a look. And if you like it, make sure to check out (another product).</p>

          <p>You are also eligible for $5 off on your first above $10 purchase!</p>
          <a href="#" class="button" style="width: 100px">Check our Site</a>
